...
public class ChallengeController {
	...
	public ResponseEntity<String> addChallenge(@RequestBody Challenge challenge) {
		...
		if(isChallengeAdded) {
			return new ResponseEntity<String>( "challenge add successfully",HttpStatus.OK);
		} else {
	...
	public ResponseEntity<Challenge> getChallenge(@PathVariable String month) {
		...
		if(challenge != null) {
			...
			return new ResponseEntity<>(HttpStatus.NOT_FOUND); ///Otherwise it was 200 OK 
		}	
	}
	
	
	@PutMapping("/{id}")
	public ResponseEntity<String> getChallenge(@PathVariable Long id,@RequestBody Challenge updatedChallenge) {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<String> getChallenge(@PathVariable Long id) {
